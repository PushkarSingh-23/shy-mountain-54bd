...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shy-mountain-54bd)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-mountain-54bd
```

A live public deployment of this template is available at [https://shy-mountain-54bd.templates.workers.dev](https://shy-mountain-54bd.templates.workers.dev)
